...
insert into contato(id, nome, email, telefone, mensagem, resolvido)
	values(null, "Altair Martins", "altair@gmail.com", "1140028922", "Solicito contato para esclarecimento de preços", false);
	
insert into contato(id, nome, email, telefone, mensagem, resolvido)
	values(null, "Rosa Maria", "rosa@gmail.com", "0112345678", "Preciso de informações sobre passagens para PCD", false);
	
insert into contato(id, nome, email, telefone, mensagem, resolvido)
	values(null, "George Mota", "mota@gmail.com", "01133565896", "Preciso tirar dúvidas referentes às formas de pagamento", false);
